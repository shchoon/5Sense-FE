    ...
    >
      <div className="w-full flex flex-col items-center gap-8">
        ...
        <div className="w-full flex flex-col gap-6">
          ...
          >
            <input id="all" checked={isClickedAccessTerm.all} className="w-4 h-4" type="checkbox" />
            <span className="w-full text-left gray-600-medium text-base">전체 약관에 모두 동의합니다.</span>
          </div>
          <div className="w-full flex flex-col gap-5">
            <div className="w-full flex cursor-pointer">
              ...
              >
                <input type="checkbox" checked={isClickedAccessTerm.first} id="firstAgree" className="w-4 h-4" />
            ...
            <div className="w-full flex gap-2.5 cursor-pointer">
              ...
              >
                <input type="checkbox" checked={isClickedAccessTerm.second} id="secondAgree" className="w-4 h-4" />
                <div className="w-[135px] h-4 flex items-center gap-1.5">
                  <span className="w-[87px] gray-600-medium text-base">이용약관 동의</span>
                  <span className="flex-1 text-left primary-600-medium">(필수)</span>
                </div>
