...
export default function MainBox() {
  ...
  return (
    <>
      <div className="w-full flex max-w-[1480px] 2xl:max-w-[1480px] xl:max-w-[1016px] lg:max-w-[936px] items-start gap-6 pt-[60px] ">
        <div className="w-full flex outline outline-1 rounded-xl 2xl:min-w-[832px] outline-gray-200 ">
        ...
        <div className="w-full flex flex-col gap-5 p-6 2xl:max-w-[416px] xl:max-w-[296px] ring-1 rounded-xl ring-gray-200">
          <div className="w-full flex flex-col gap-2 ">
            <div className="text-gray-600 text-base font-semibold font-['Pretendard'] leading-normal">
              전체 등록 학생 수
            </div>
      ...
      {/* 메모장 */}
      <div className="w-full max-w-[1480px] h-[220px] p-6 border mt-10">
