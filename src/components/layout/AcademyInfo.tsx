    ...
    <div className="infoContent w-full flex flex-col items-center gap-7">
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="infoDetail flex flex-col items-center gap-2">
          <p className={`${props.color} text-[21px] font-bold`}>매직기구필라테스</p>
          <p className={`${props.color} h-[14px] text-sm font-medium`}>031-706-1281</p>
          <p className={`${props.color} h-3 text-xs font-medium `}>경기 성남시 분당구 판교로256번길 19</p>
        </div>
      </div>
      <button
