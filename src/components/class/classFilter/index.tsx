...
import chevronDownGray from 'public/assets/icons/chevron/chevron-down-gray.svg'
import chevronUpGray from 'public/assets/icons/chevron/chevron-up-gray.svg'
  ...
  return (
    <div className="absolute left-12 top-[120px] flex flex-col gap-2 h-[50px]">
      <div className=" max-w-[375px] h-[37px] items-start gap-2 flex">
        ...
        >
          <span className="w-16 h-[21px] text-[11.5px]indigo-500-semibold group-hover:text-white group-focus:text-white">
        ...
        >
          <span className="max-w-[110px] h-[21px] text-[11.5px]indigo-500-semibold group-hover:text-white group-focus:text-white">
        ...
        >
          <span className="w-[49px] h-[21px] text-[11.5px]indigo-500-semibold group-hover:text-white group-focus:text-white">
          ...
          >
            ...
            >
              <p className="flex gap-2 items-center">
                ...
                <label
                  htmlFor="timeClass"
                  className="gray-900-semibold text-sm"
                >
                  회차반
                </label>
              </p>
            ...
            <div className="w-full flex flex-col gap-3">
              <div className="w-full h-[42px] p-3 border rounded-lg border-gray-200 bg-gray-50 flex gap-2 focus:border-none focus-within:ring-1 focus-within:ring-[#7354E8]">
                ...
                <input
                  ...
                  placeholder="강사이름"
                  value={searchTeacher}
                  className="w-full h-full border-none focus:ring-0 gray-500-normal text-sm"
                  onChange={event => {
                    ...
                    if (teacher.name.includes(searchTeacher)) {
                      return (
                        <div key={i} className="w-full flex items-center gap-2">
                          ...
                          />
                          <span
                            className="text-[#7354E8] text-sm font-normal hover:cursor-pointer"
                            id={teacher.name}
                            onClick={e => {
        ...
        {isClickedCategoryFilter ? (
          ...
          >
            <div className="relative">
              ...
              >
                <span className="w-[90%] text-left gray-500-normal text-sm">
                  {groupClass.subject !== ''
                    ? groupClass.subject
                    : '대분류 선택'}
                </span>
                    ...
                    {category.map((group, i) => {
                      return (
                        <div
                          key={i}
                          id={group.subject}
                          className="rounded-[3px] px-2 py-1 gray-900-normal text-sm hover:bg-purple-100"
                          onClick={e => {
                            setGroupClass({
                              ...groupClass,
