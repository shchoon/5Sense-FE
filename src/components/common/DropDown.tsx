...
export default function DropDown({ height, px, py, dropDownList, name }: DropDownPropsType) {
  ...
  return (
    <div className="relative w-full flex items-center cursor-pointer" onClick={handleClickDropDown}>
      <div
      ...
      >
        <div className="h-[18px] gray-500-normal text-sm font-['Pretendard']">{clickedItem}</div>
      </div>
      <Image className="absolute right-4" src={chevron_gray} width={16} height={16} alt="cheveon_gray" />
      {isClickDropDown && (
        <div
